...
#     print (df)
    ...
    print("===================",df)
    list_text = df['Answer'].astype(str).values.tolist()
...
#             print("hjn", path0)
            path = os.mkdir(path0)
            print(len(heading_text),len(sents))
...
import os
app = Flask(__name__)
app.config["IMAGE_UPLOADS"] = "/media/patient/02/NN/Marketing_Project/center"
app.config["FILE_UPLOADS"] = "/media/patient/02/NN/Marketing_Project/center"
